...
GIGACHAT_CREDENTIALS = 'MTg0ODNhZDUtOGEwMS00Y2I4LWE2MjgtMzIwM2Y1YzMyZWJiOjA2NDI2MTNlLWRjODctNGQzYS1hNWU3LTU0NjkzMjkzMmQzMg=='  # Замените на ваш ключ
VERIFY_SSL_CERTS = False
API_TOKEN = '7583689978:AAGflEDcb6XyDfwGjsAzNzKYJ7MBl56aPXI'
bot = telebot.TeleBot(API_TOKEN)

user_balances = {}
user_last_daily_bonus = {}
tales= ["""Жили-были старик со старухой. Вот и просит старик:
...
А лиса его – гам! – и съела.""","""Жила-была семья. У них не было детей.
  И как то раз родился у них сын. И у их сыночка появился понос. Когда же семья вылечила ребёнка, он стал какать странно. И вот один раз малыш по какал и вдруг какашка ожила. О, чудо!  Но семья не приняла её в семью и выгнала. А какашка была странная и бедная. Куда бы она не пошла, её прогоняют.
 Какашка думала, думала и придумала. Сказала какашка "А может пойти мне в королевский замок? Вдруг меня примет король?" И вот пошла какашка в королевский замок. на пути она встретила дворника. "Кто разрешал здесь срать?!??!"-воскликнул дворник."убирать опять я буду, за что?!" Дворник взял веник и совок. Начал убирать какашку. Но наша смелая какашка спряталась за странный кустик. Уж, больно он был жёлтенький и вонючий. Нанюхалась сяк какашка и пошла дальше.
 Набрела она на замок. Много страж наступили на неё. И вот плоская какашечка подобралась к королю. Из замка раздался крик "Иди от сюда несчастная!"
 Вылетела какашка из окна сурового короля! Села на пенёк и плачет. Из кустов вышел гоблин. Быстро подружились они.и стали они поживать и добра наживать.""",
"""Был жаркий летний день. Герасим как обычно копошился на работе, всё

проходило как и всегда, однако после смерти своего лучшего друга,

ближайшей к нему душе, он стал очень грустный и вялый.

По окончанию работы, он приходил к тому озеру, где и погибла Муму,

всякий раз прося прощение за содеянное. По приходу в деревню он заметил

тревогу в глазах односельчан и решил жестами выяснить что случилось.

Одна из старух сказала ему, что вчера утром её муж ушёл на рыбалку и до

сих пор не вернулся, она указала Герасиму озеро, куда отправлялся старик.

Герасим пообещал, что найдёт старика. Подойдя к озеру, Герасим сразу

принялся за поиски мужика, однако ни его, ни даже следов его пребывания

здесь не было. Но тут из озера показалась лодка, Герасим аккуратно вытащил

её из воды, там и оказался мужик. Он лежал лицом вниз, Герасим сразу

понял, что тот погиб, но стоило ему перевернуть тело старика… оно было в

крови и глубоких ранах, будто кто-то драл его и трепал. Ужас наступил на

лицо бедного, от страха он замер на месте. С ужасом Герасим отнёс тело в

деревню и сразу отправился к себе в хижину.

Ночью была сильная гроза и гром, слышался хруст деревьев. Было слышно

как ветви касаются крыш домов.

На утро Герасим вышел из дома и ужаснулся от увиденного, деревья были

вырваны с корнями, множество домов обрушилось. Вдруг Герасим увидел

Барыню, это была именно она, бездыханное тело женщины лежало

искусанное и было в крови. Была гробовая тишина, казалось Герасим один

выжил, он пытался закричать.

Но вдруг дверь одной из хижин заскрипела и из неё вышло несколько

мужиков и девушек. Они объяснили Герасиму, что все остальные погибли

ещё ночью. В спешке крестьяне начали громко и бурно обсуждать, как

спастись он такой напасти. В конце концов решили строить крепкий дом для

всех кто выжил. Люди принялись за работу, одни запасали еду, другие

строили, третьи загоняли выживший скот.

Стемнело. Жители улеглись спать, только Герасим не спал. Неожиданно

тишина нарушилась непонятной вознёй в кустах. Герасим вышел посмотреть

кто это. Шелест и возня прекратились и из кустов вышел тот, кого знали все,

но никто не ожидал увидеть. Это был ни кто иной как Муму, вот только

гораздо больше в размерах и доброта… её не было.

Увидев её Герасим закрыл лицо руками, глаза наполнились горячими

слезами, он обнял Муму, говорил, как скучал по ней, и что он очень виноват

перед ней . Он закрыл глаза, а когда открыл, никого не было. С тех пор Муму

стала навещать его и стала такой же доброй как и при жизни.""","""В одной из отдаленных улиц Москвы, в сером доме с белыми колоннами, антресолью и покривившимся балконом, жила некогда барыня, вдова, окруженная многочисленною дворней. Сыновья ее служили в Петербурге, дочери вышли замуж; она выезжала редко и уединенно доживала последние годы своей скупой и скучающей старости. День ее, нерадостный и ненастный, давно прошел; но и вечер ее был чернее ночи.
...
chat = GigaChat(credentials=GIGACHAT_CREDENTIALS, verify_ssl_certs=VERIFY_SSL_CERTS)
messages = [SystemMessage(content="Ты бот Vilka. Ты предназначен для того чтобы помогать людям и чтобы тобой ели.")]



def gigachat_communication(message):
    global messages  # Обращаемся к глобальной переменной messages
    user_input = message.text
    if user_input.lower() == "выход":
        messages = [SystemMessage(content="Ты бот Vilka. Ты предназначен для того чтобы помогать людям и чтобы тобой ели.")] #Сбрасываем историю сообщений
    ...
    try:
        ...
        bot.register_next_step_handler(message, gigachat_communication)
    except Exception as e:  # Обрабатываем потенциальные ошибки
        bot.send_message(message.chat.id, f"Произошла ошибка: {e}")
        start_handler(message)
def get_balance(user_id):
    return user_balances.get(user_id, 20)
...
def skibidisigma(message):
    markup = telebot.types.ReplyKeyboardRemove(selective=False)  # Скрываем клавиатуру при входе в казино
    ...
    while balance >= 5:
        ...
        KOMBO = random.randint(1, 100)
        FirstTop = random.sample(range(1, 101), 19)
        while KOMBO in FirstTop:
            FirstTop = random.sample(range(1, 101), 19)

        SecondTop = random.sample(range(1, 101), 20)
        while KOMBO in SecondTop or any(x in SecondTop for x in FirstTop):
            SecondTop = random.sample(range(1, 101), 20)

        msg = bot.send_message(message.chat.id, "С вас сняли 5 казикоинов за участие. \nВведите число от 1 до 100. Напиши СТОП, чтобы закончить.",reply_markup=markup )
        bot.register_next_step_handler(msg, lambda m: process_casino_guess(m, KOMBO, FirstTop, SecondTop))
        return


def process_casino_guess(message, KOMBO, FirstTop, SecondTop):
    user_id = message.from_user.id
    balance = get_balance(user_id)

    if message.text.upper() == "СТОП":
        bot.send_message(message.chat.id, f"Конец игры. Ваш баланс: {balance}")
        start_handler(message)
        return

    try:
        duf = int(message.text)
        if 1 <= duf <= 100:
            if duf == KOMBO:
                bot.send_message(message.chat.id, "Вы выиграли КОМБО. Вы получили 50 казикоинов")
                update_balance(user_id, 50)
            elif duf in FirstTop:
                bot.send_message(message.chat.id, "Вы заняли 1 место. Вы выиграли 10 казикоинов")
                update_balance(user_id, 10)
            elif duf in SecondTop:
                bot.send_message(message.chat.id, "Вы заняли 2 место. Вы ничего не получили")
            else:
                bot.send_message(message.chat.id, "Вы заняли 3 место. У вас снято 10 казикоинов")
                update_balance(user_id, -10)
        else:
    ...
    if balance >= 5:
        skibidisigma(message)
    else:
        bot.send_message(message.chat.id, f"У вас нет денег. Выход из режима казино. Баланс: {balance}\n\n")
        start_handler(message)


def matchh(message):
    markup = telebot.types.ReplyKeyboardRemove(selective=False)
    bot.send_message(message.chat.id, "Введите пример (напишите 'СТОП' чтобы закончить)", reply_markup=markup)
    bot.register_next_step_handler(message, process_example)


def process_example(message):
    Kakashka = message.text
    if Kakashka == 'СТОП':
        bot.send_message(message.chat.id, "Хорошо. Что будем делать дальше?")
        start_handler(message)
        return
    try:
        result = eval(Kakashka)
        bot.send_message(message.chat.id, f"Ответ: {result}")
    except Exception as e:
        bot.send_message(message.chat.id, "Некорректный пример")
    matchh(message)


def supernova(message):
    markup = telebot.types.ReplyKeyboardMarkup(row_width=3, resize_keyboard=True)
    btn1 = telebot.types.KeyboardButton('Камень')
    btn2 = telebot.types.KeyboardButton('Ножницы')
    btn3 = telebot.types.KeyboardButton('Бумага')
    btn4 = telebot.types.KeyboardButton('Стоп')
...
def process_game(message):
    ponos = message.text.lower()
    uzbek = random.choice(["камень", "ножницы", "бумага"])

    if ponos == 'камень':
        bot.send_message(message.chat.id, f"Бот выбрал: {uzbek}")
        if uzbek == 'камень':
        ...
        markup = telebot.types.ReplyKeyboardRemove(selective=False)
        bot.send_message(message.chat.id, "Конец игры, пока пока!\n", reply_markup=markup)
        start_handler(message)
    else:
        bot.send_message(message.chat.id, "ОШИБКА (нажмите на кнопку)\n")
        supernova(message)


def able(message):
    markup = telebot.types.ReplyKeyboardRemove(selective=False)
    bot.send_message(message.chat.id, "Выберете сказку (муму, муму2, сказка про какашку, колобок)", reply_markup=markup)
    bot.register_next_step_handler(message, send_tale)


def send_tale(message):
    a1448 = message.text.lower()
    tale_text = ""
    ...
    if a1448 == 'муму':
        ...
        tale_text = tales[0]
    elif a1448 == 'сказка про какашку':
        tale_text = tales[1]
    else:
        bot.send_message(message.chat.id, "Такой сказки нет, введите ещё раз.")
        able(message)
        return

    if tale_text:
        message_parts = [tale_text[i:i + 4096] for i in range(0, len(tale_text), 4096)]
...
def add_coin(message):
    ...
    bot.send_message(message.chat.id, f"Ваш баланс: {get_balance(user_id)}")
    start_handler(message)


user_first_interaction = {}  # Словарь для отслеживания первого взаимодействия
...
def daily_bonus(message):
    ...
    last_bonus_time = user_last_daily_bonus.get(user_id)

    if last_bonus_time is None or current_time - last_bonus_time >= 86400:
        bonus = random.randint(5, 200)
        update_balance(user_id, bonus)
        user_last_daily_bonus[user_id] = current_time
        bot.send_message(message.chat.id,
                         f"Вы получили ежедневный бонус! +{bonus} казикоинов. Ваш баланс: {get_balance(user_id)}")
    else:
        ...
        bot.send_message(message.chat.id,
                         f"Вы уже получали бонус сегодня. Попробуйте через {hours_left}ч {minutes_left}мин {seconds_left}сек.")
...
def start_handler(message):
    ...
    if not user_first_interaction.get(user_id, False):
        user_first_interaction[user_id] = True
        bot.send_message(message.chat.id,
                         "Здравствуйте! Вас приветствует бот VILKA, я буду рекомендовать вам музыку, видео и т.д., рассказывать сказки и многое другое!\nВыберите действие:",
                         reply_markup=markup)

    btn1 = telebot.types.KeyboardButton('Сказки')
    btn2 = telebot.types.KeyboardButton('Камень, ножницы, бумага')
    btn3 = telebot.types.KeyboardButton('Калькулятор')
    btn4 = telebot.types.KeyboardButton('Казино')
    btn5 = telebot.types.KeyboardButton('Получить монетку')
    btn6 = telebot.types.KeyboardButton('Ежедневный бонус')  # Новая кнопка
    btn7 = telebot.types.KeyboardButton('Общение')  # Новая кнопка "Общение"
...
def process_main_menu_choice(message):
    ...
    if a == 'Сказки':
        ...
        balance = get_balance(user_id)
        if balance < 5:
            bot.send_message(message.chat.id, "У вас нет денег. Получите монетку.")
            start_handler(message)
        else:
            skibidisigma(message)
    elif a == 'Получить монетку':
        add_coin(message)
    elif a == 'Ежедневный бонус':
        daily_bonus(message)  # Вызываем функцию ежедневного бонуса
    elif a == 'Общение':
        markup = telebot.types.ReplyKeyboardRemove(selective=False)  # Убираем меню, когда начался диалог
        bot.send_message(message.chat.id, "Введите сообщение (или напишите 'выход' для завершения):",
                         reply_markup=markup)
        bot.register_next_step_handler(message, gigachat_communication)
    else:
